...
def login(user_id):
    ...
    return render_template("apple_login.html", developer_token=DEVELOPER_TOKEN, user_id=user_id)
...
def callback():
    ...
    firebase_operations.if_not_exists_insert_userlinkedapps(user_id, 2, user_token, "", "")
