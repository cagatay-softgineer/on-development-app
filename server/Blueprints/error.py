...
def bad_request(e):
    ...
    return render_template("error.html", error_message="Bad request. Please check your input.", error_code=400), 400
...
def unauthorized(e):
    ...
    return render_template("error.html", error_message="Unauthorized access.", error_code=401), 401
...
def forbidden(e):
    ...
    return render_template("error.html", error_message="Forbidden.", error_code=403), 403
...
def page_not_found(e):
    ...
    return render_template("error.html", error_message="The endpoint you are looking for does not exist.", error_code=404), 404
...
def method_not_allowed(e):
    ...
    return render_template("error.html", error_message="Method not allowed for this endpoint.", error_code=405), 405
...
def request_timeout(e):
    ...
    return render_template("error.html", error_message="Request timed out. Please try again.", error_code=408), 408
...
def too_many_requests(e):
    ...
    return render_template("error.html", error_message="You have sent too many requests in a given time.", error_code=429), 429
...
def internal_server_error(e):
    ...
    return render_template("error.html", error_message="An internal server error occurred. Please try again later.", error_code=500), 500
