...
import 'package:pomodoro/widgets/bar/custom_player_bar.dart';
import 'package:pomodoro/widgets/icon/glowing_icon.dart';
import 'package:pomodoro/widgets/notification/app_notification.dart';
  ...
  void didUpdateWidget(covariant MusicPlayerWidget oldWidget) {
    ...
    if (widget.songTitle != oldWidget.songTitle) {
      AppNotifier.show(
        ...
        message: "${widget.songTitle} is Playing",
